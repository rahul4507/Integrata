...
export const AirtableIntegration = ({ user, org, integrationParams, setIntegrationParams }) => {
    ...
    const { allItems, dataLoading, fetchAllItems, clearData } = useIntegrationData('Airtable', integrationParams?.credentials);
    ...
    const handleSearch = async () => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:8001/integrations/airtable/search', formData);
